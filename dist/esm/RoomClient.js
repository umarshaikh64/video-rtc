...
import { LOCAL_STORAGE_DEVICES, _EVENTS, mediaType, } from "./types/VideoRtc.type";
import { getAudioConstraints, getCameraConstraints, getEncoding, getScreenConstraints, getVideoConstraints, } from "./VideoRtc.helper";
var RoomClient = /** @class */ (function () {
    ...
    RoomClient.prototype.join = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                this.socket
                    .request("join", data)
                    .then(function (room) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.consumerTransport.on("connectionstatechange", function (state) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (state) {
                                    case "connecting":
                                        break;
    ...
    RoomClient.prototype.initSockets = function () {
        ...
        this.socket.on("newProducers", function (data) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.getConsumeStream(producer_id, peer_info.peer_id, type).then(function (_a) {
                    ...
                    if (_this.eventListeners.has(_EVENTS.remoteVideo)) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        streamId = peer_id + (type === mediaType.screen ? "-screensharing" : "-mic-webcam");
